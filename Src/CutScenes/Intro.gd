...
func window_three():
	...
	tie.buff_silence(1)
	tie.buff_text(" nothing changed after achieveing this power.\n", .05)
	tie.buff_silence(.5)
...
func window_four():
	...
	tie.buff_silence(1)
	tie.buff_text("Learned scholars travled to record, and study the historic moment.\n", .05)
	tie.buff_silence(1)
	tie.buff_text("Shifty theifs navigated to the basement in hopes of stealing it.\n", .05)
	tie.buff_silence(2)
	tie.set_state(tie.STATE_OUTPUT)
...
func window_six():
	...
	tie.buff_silence(1)
	tie.buff_text(" and decide to flaten this world.", .05)
	tie.buff_silence(2)
	tie.set_state(tie.STATE_OUTPUT)
...
func window_seven():
	...
	tie.buff_text("You must vanguish these soon to be horsemen of the apocalypse.\n", .05)
	tie.buff_silence(2)
